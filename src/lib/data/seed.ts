  ...
  return [
    {
      ...
      services: [
        { id: "s1", client_id: "c1", kind: "retainer", amount: 6500, currency: "UYU", billing_day: 5, active: true, starts_on: period(6), first_month_free: false },
        { id: "s2", client_id: "c1", kind: "ads", amount: 250, currency: "USD", billing_day: 5, active: true, starts_on: period(6), first_month_free: false },
      ],
      payments: [
    ...
    },
    {
      ...
      setup_note: null,
      services: [
        { id: "s3", client_id: "c2", kind: "web", amount: 4200, currency: "UYU", billing_day: 1, active: true, starts_on: period(6), first_month_free: false },
      ],
    ...
    },
    {
      ...
      setup_note: null,
      services: [
        { id: "s4", client_id: "c3", kind: "retainer", amount: 5000, currency: "UYU", billing_day: 10, active: true, starts_on: period(6), first_month_free: false },
        { id: "s5", client_id: "c3", kind: "ads", amount: 400, currency: "USD", billing_day: 10, active: true, starts_on: period(6), first_month_free: false },
      ],
    ...
    },
    {
      ...
      setup_note: null,
      services: [
        { id: "s6", client_id: "c4", kind: "web", amount: 3800, currency: "UYU", billing_day: 20, active: true, starts_on: period(6), first_month_free: false },
      ],
    ...
    },
    {
      ...
      setup_note: null,
      services: [
        { id: "s7", client_id: "c5", kind: "retainer", amount: 3500, currency: "UYU", billing_day: 28, active: true, starts_on: period(6), first_month_free: false },
      ],
